...
public interface IFortranAPIHelpProvider
{
     ...
     * @param selectedText the word under the caret in the Fortran editor; or, if the editor
     *            selection is nonempty, the text in the editor selection; or, if this method is
     *            being invoked from a source other than an editor (e.g., by the Fortran Declaration
     *            view), the name of an API type, procedure, or constant (nonempty, non-
     *            <code>null</code>)
     * 
     * @return a list of help resources for the given Fortran editor with the given selected text
     *         (possibly <code>null</code>)
     */
    IHelpResource[] getHelpResources(ITextEditor fortranEditor, String selectedText);
}
